  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">SERVANTHOOD CENTRE</span></a>
      </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#feature">About</a></li>
          <li><a href="#organisations">Ministries</a></li>
          <li><a href="#courses">Events</a></li>
          <li><a href="#pricing">Sermons</a></li>
        <li class="btn-trial"><a href="{{route('register')}}">Register</a></li>
          <li class="btn-trial"><a href="{{route ('login')}}">Login</a></li>
        </ul>
      </div>
    </div>
        ...
        <div class="row">
          <div class="banner-text text-center">
            ...
            <div class="intro-para text-center quote">
              <p class="big-text">Life is better together.</p>
              <p class="small-text"><span>Psalm 16:8</span>
               I keep my eyes always on the LORD. With him at my right hand,<br> I will not be shaken.</p>
